...
<?php if ( $multi_shipping_data ) : ?>
	<?php foreach ( $multi_shipping_data as $item_id => $item ) : ?>
		...
		<?php $first = true; ?>
<style>
	body.postid-<?php echo $cart[$item_id]['product_id']; ?> #pro-<?php echo $cart[$item_id]['variation_id']; ?>-s{
		display: block;
	}
</style>
        <table class="table ywcmas_addresses_manager_table shop_table_responsive" id="pro-<?php echo $product->get_id(); ?>-s">
            <thead>
                ...
                <tr class="ywcmas_addresses_manager_table_shipping_selection_row">
					<?php if ( $first ) : ?>
                        <td class="ywcmas_addresses_manager_table_product_name_td" data-title="<?php echo $product_title; ?>">
                            ...
                            <div><?php echo wc_get_formatted_cart_item_data( $cart[$item_id], true ); ?></div>
                        </td>
					<?php else : ?>
