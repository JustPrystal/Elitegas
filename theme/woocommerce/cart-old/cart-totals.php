...
<tr>
		<td colspan="2">
<!-- 				<div class="detailbtnd"><sapn>Order Instructions</sapn> <i class="fas fa-chevron-down"></i></div>
 -->
			<div class="detailbtn"><sapn>Order Instructions</sapn> 
<!-- 				<i class="fas fa-chevron-down"></i> -->
			</div>
			<table class="detailsshowituil">
...
<tr>
		<td colspan="2">
			<span class="taxesandshiping">Taxes & Shipping calculated at checkout</span>
	</td>
