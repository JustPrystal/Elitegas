		...
		<div class="<?php echo pmpro_get_element_class( 'pmpro_checkout-fields' ); ?>">
			...
			<div class="<?php echo pmpro_get_element_class( 'pmpro_checkout-field pmpro_checkout-field-password', 'pmpro_checkout-field-password' ); ?>">
				...
				<input id="password" name="password" type="password" class="<?php echo pmpro_get_element_class( 'input', 'password' ); ?>" size="30" value="<?php echo esc_attr($password); ?>" />
				    <span toggle="#password" class="fa fa-fw fa-eye field-icon toggle-password hide-show-password"></span>
<!-- 				<p id="pswd_info">
					Required: <span id="capital" class="invalid"><strong>one capital letter</strong></span> <span id="letter" class="invalid"><strong>one Special Character</strong> </span> <span id="number" class="invalid"><strong>one number</strong></span>
					<span id="length" class="invalid"><strong>8 characters</strong></span>
				</p> -->
<div id="pswd_info">
    <ul>
        <li id="letter" class="invalid"><strong>Must have at least 1 special character (!,$,@,%,#)</strong></li>
        <li id="capital" class="invalid"><strong>Must have at least 1 capital letter</strong></li>
        <li id="number" class="invalid"><strong>Must have at least 1 number</strong></li>
...
$(document).ready(function() {
    ...
    $('#password[type=password]').keyup(function() {
        // keyup code here
          var pswd = $(this).val();
			...
			<?php
				...
				if($pmpro_checkout_confirm_password) { ?>
					<div class="<?php echo pmpro_get_element_class( 'pmpro_checkout-field pmpro_checkout-field-password2', 'pmpro_checkout-field-password2' ); ?>">
					  ...
					  <span toggle="#password2" class="fa fa-fw fa-eye field-icon toggle-password hide-show-password"></span>	
